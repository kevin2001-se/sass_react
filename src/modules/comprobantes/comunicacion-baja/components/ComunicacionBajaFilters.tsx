...
import type { ComunicacionBajaFilters as Filters } from "../types/comunicacionBaja.types"

export function ComunicacionBajaFilters({ filters, onChange, onClear }: { filters: Filters; onChange: (filters: Filters) => void; onClear: () => void }) {
      ...
      <CardContent className="grid gap-4 p-4 md:grid-cols-5">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input id="identificador" placeholder="RA-20260619-001" value={filters.identificador ?? ""} onChange={(event) => update("identificador", event.target.value)} />
